...
public class CharacterDAO
{
	...
	public boolean insert(Player player)
	{
		...
		try
		{
			...
			statement.setInt(27, player.getNobleType().ordinal());
			statement.setInt(28, player.getUsedWorldChatPoints());
			statement.setInt(29, player.hideHeadAccessories() ? 1 : 0);
