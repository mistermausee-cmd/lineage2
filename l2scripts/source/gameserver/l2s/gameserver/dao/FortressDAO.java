...
public class FortressDAO
{
	...
	public static final String REPLACE_SQL_QUERY = "REPLACE INTO fortress (id, name, state, castle_id, last_siege_date, owner_id, own_date, siege_date, supply_count, facility_0, facility_1, facility_2, facility_3, facility_4, cycle, reward_count, paid_cycle) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
