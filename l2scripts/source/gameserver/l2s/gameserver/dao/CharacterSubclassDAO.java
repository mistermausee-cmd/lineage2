...
public class CharacterSubclassDAO
{
	...
	public static final String SELECT_SQL_QUERY = "SELECT class_id, default_class_id, exp, sp, curHp, curCp, curMp, active, type, certification, dual_certification, vitality, used_vitality_potions FROM character_subclasses WHERE char_obj_id=?";
	public static final String INSERT_SQL_QUERY = "INSERT INTO character_subclasses (char_obj_id, class_id, default_class_id, exp, sp, curHp, curMp, curCp, maxHp, maxMp, maxCp, level, active, type, certification, dual_certification, vitality, used_vitality_potions) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public boolean insert(int objId, int classId, int dafaultClassId, long exp, long sp, double curHp, double curMp, double curCp, double maxHp, double maxMp, double maxCp, int level, boolean active, SubClassType type, int certification, int dualCertification, int vitality, int vitalityUsedPotions)
	{
		Connection con = null;
