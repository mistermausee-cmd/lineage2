...
public class AdminAttributes implements IAdminCommandHandler
{
	...
	public void showMainPage(Player activeChar)
	{
		...
		replyMSG.append("<button value=\"Shirt\" action=\"bypass -h admin_setattun $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		...
		replyMSG.append("<button value=\"Cloak\" action=\"bypass -h admin_setattba $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		...
		replyMSG.append("<button value=\"R-Bracelet\" action=\"bypass -h admin_setattrbr $menu_command_0 $menu_command_1 $menu_command_2 $menu_command_3 $menu_command_4 $menu_command_5\" width=50 height=20 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td width=50>&nbsp;</td><td>");
