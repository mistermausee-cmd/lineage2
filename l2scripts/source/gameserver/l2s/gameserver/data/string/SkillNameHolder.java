			...
			else
			{
				...
				try
				{
					...
					while((line = reader.readLine()) != null)
					{
						...
						int subLevel = Integer.parseInt(token.nextToken());
                        int levelMask = SkillUtils.getSkillLevelMask(level, subLevel);
                        int hashCode = SkillUtils.generateSkillHashCode(id, levelMask);
