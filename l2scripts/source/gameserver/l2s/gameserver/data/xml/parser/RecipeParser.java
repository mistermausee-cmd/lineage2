...
public final class RecipeParser extends AbstractParser<RecipeHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for(Iterator<Element> iterator = rootElement.elementIterator(); iterator.hasNext();)
		{
			...
			boolean awakedOnly = element.attributeValue("awaked_only") == null ? false : Boolean.parseBoolean(element.attributeValue("awaked_only"));
		    long addRateAdena = element.attributeValue("add_adena_rate") != null ? Long.parseLong(element.attributeValue("add_adena_rate")) : 0;
		      
			RecipeTemplate recipe = new RecipeTemplate(id, level, mpConsume, successRate, itemId, isCommon, awakedOnly, addRateAdena);
