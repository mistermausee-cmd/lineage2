				...
				for(Iterator<Element> subIterator = element.elementIterator(); subIterator.hasNext();)
				{
					...
					else if(nodeName.equalsIgnoreCase("related_fortresses"))
					{
						for(Iterator<Element> thirdElementIterator = subElement.elementIterator(); thirdElementIterator.hasNext();)
						{
							...
							if(thirdElement.getName().equalsIgnoreCase("domain"))
								((Castle) residence).addRelatedFortress(Fortress.DOMAIN, Integer.parseInt(thirdElement.attributeValue("fortress")));
							else if(thirdElement.getName().equalsIgnoreCase("boundary"))
								((Castle) residence).addRelatedFortress(Fortress.BOUNDARY, Integer.parseInt(thirdElement.attributeValue("fortress")));
						}
					}
