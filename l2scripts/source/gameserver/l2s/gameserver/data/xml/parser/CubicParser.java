...
public final class CubicParser extends AbstractParser<CubicHolder>
{
	...
	protected void readData(Element rootElement) throws Exception
	{
		for(Iterator<Element> iterator = rootElement.elementIterator(); iterator.hasNext();)
		{
			...
			int sub_level = cubicElement.attributeValue("sub_level") == null ? 0 : Integer.parseInt(cubicElement.attributeValue("sub_level"));
			...
			CubicTemplate template = new CubicTemplate(id, SkillUtils.getSkillLevelMask(level, sub_level), slot, duration, delay, max_count, use_up, power, target_type);
			...
			for(Iterator<Element> skillIterator = cubicElement.elementIterator("skill"); skillIterator.hasNext();)
			{
				...
				int sub_level2 = skillElement.attributeValue("sub_level") == null ? 0 : Integer.parseInt(skillElement.attributeValue("sub_level"));
				...
				Skill skill = SkillHolder.getInstance().getSkill(id2, SkillUtils.getSkillLevelMask(level2, sub_level2));
				if(skill == null)
					continue;
