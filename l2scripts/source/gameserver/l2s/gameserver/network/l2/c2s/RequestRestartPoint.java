		...
		switch(restartType)
		{
			...
			case TO_FORTRESS:
				if(clan != null && clan.getHasFortress() != 0)
				{
		            ...
		            teleportPoint = TeleportUtils.getRestartPoint(activeChar, RestartType.TO_FORTRESS);
		            ResidenceFunction function = fort.getActiveFunction(ResidenceFunctionType.RESTORE_EXP);
		            if(function != null)
		            	activeChar.restoreExp(function.getTemplate().getExpRestore() * 100); 
				}
				break;
