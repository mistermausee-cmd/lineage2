...
public class MoveBackwardToLocation extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(_keyboardMovement == 0 && !Config.ALLOW_KEYBOARD_MOVE)
		{
		...
		activeChar.moveToLocation(_targetLoc, 0, !activeChar.getVarBoolean("no_pf"), true, _keyboardMovement == 0);
	}
}