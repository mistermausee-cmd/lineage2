...
public class CharacterCreate extends L2GameClientPacket
{
	...
	public static void initNewChar(Player newChar)
	{
        ...
        newChar.registerShortCut(new ShortCut(0, 10, ShortCut.TYPE_SKILL, 911, 1, 1));
        newChar.registerShortCut(new ShortCut(3, 10, ShortCut.TYPE_SKILL, 884, 1, 1));
        newChar.registerShortCut(new ShortCut(4, 10, ShortCut.TYPE_SKILL, 885, 1, 1));
        newChar.registerShortCut(new ShortCut(0, 11, ShortCut.TYPE_ACTION, 70, 0, 1));
