...
public class RequestRegistBeauty extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(set == null)
		{
			activeChar.sendPacket(new ExResponseBeautyRegistResetPacket(activeChar, ExResponseBeautyRegistResetPacket.CHANGE, ExResponseBeautyRegistResetPacket.FAILURE));
			activeChar.sendPacket(new ExResponseBeautyListPacket(activeChar, ExResponseBeautyListPacket.HAIR_LIST));
			return;
		}
		...
		activeChar.sendPacket(new ExResponseBeautyRegistResetPacket(activeChar, ExResponseBeautyRegistResetPacket.CHANGE, ExResponseBeautyRegistResetPacket.SUCCESS));
		activeChar.sendPacket(new ExResponseBeautyListPacket(activeChar, ExResponseBeautyListPacket.HAIR_LIST));
	}
}