...
public class RequestShowResetShopList extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(set == null)
		{
			activeChar.sendPacket(new ExResponseBeautyRegistResetPacket(activeChar, ExResponseBeautyRegistResetPacket.RESTORE, ExResponseBeautyRegistResetPacket.FAILURE));
			return;
		}
		...
		activeChar.sendPacket(new ExResponseBeautyRegistResetPacket(activeChar, ExResponseBeautyRegistResetPacket.RESTORE, ExResponseBeautyRegistResetPacket.SUCCESS));
	}
}