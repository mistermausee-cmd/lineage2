...
public class MagicSkillLaunchedPacket extends L2GameServerPacket
{
	...
	public MagicSkillLaunchedPacket(int casterId, int skillId, int skillLevel, Creature target, boolean dual)
	{
		_casterId = casterId;
		_skillId = skillId;
	...
	public MagicSkillLaunchedPacket(int casterId, int skillId, int skillLevel, Collection<Creature> targets, boolean dual)
	{
		_casterId = casterId;
		_skillId = skillId;
		_skillLevel = skillLevel;
