...
public class CIPacket extends L2GameServerPacket
{
	...
	private boolean _chaosFestivalWinner, _showHeadAccessories;
	private int _armorSetEnchant, _usedAbilitiesPoints;
	...
	public CIPacket(Creature cha, Player receiver)
	{
		...
		for(int PAPERDOLL_ID : PAPERDOLL_ORDER)
		{
			...
			int itemId = player.getInventory().getPaperdollVisualId(PAPERDOLL_ID);
			if(itemId <= 0)
		...
		_usedAbilitiesPoints = player.getUsedAbilitiesPoints();
