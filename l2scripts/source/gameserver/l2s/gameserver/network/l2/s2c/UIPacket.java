...
public class UIPacket extends AbstractMaskPacket<UserInfoType>
{
	...
	private int mount_type, raidPoints, _raidPoints, _availableAbilitiesPoints;
	...
	private final boolean _hideHeadAccessories, _chaosFestivalWinner;
	...
	public UIPacket(Player player, boolean addAll)
	{
	    ...
	    noble = player.getNobleType().ordinal();
		...
		_raidPoints = 0;
		_availableAbilitiesPoints = player.getAllowAbilitiesPoints();
