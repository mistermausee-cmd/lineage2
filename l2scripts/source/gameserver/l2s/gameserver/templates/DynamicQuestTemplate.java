...
public class DynamicQuestTemplate
{
	...
	private final List<ItemInstance> _rewards;
	private final List<ItemInstance> _eliteRewards;
	private final List<DynamicQuestDate> _startDates;

	public DynamicQuestTemplate(int questId, int taskId, String questName, String questPath, String questTitle, int duration, int minLevel, int points, int nextTaskId, boolean autostart, String spawnGroup, List<Zone> zones, List<DynamicQuestDate> dates, Map<Integer, Integer> killPoints, List<ItemInstance> rewads, List<ItemInstance> eliteRewads, Map<String, String> dialogs)
	{
		_questId = questId;
		_taskId = taskId;
	...
	public List<ItemInstance> getAllRewards()
	{
		return _rewards;
	}

	public List<ItemInstance> getAllEliteRewards()
	{
