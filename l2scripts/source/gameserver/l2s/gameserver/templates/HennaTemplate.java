...
public class HennaTemplate
{
	...
	public HennaTemplate(int symbolId, int dyeId, int dyeLvl, long drawPrice, long drawCount, long removePrice, long removeCount, int wit, int intA, int con, int str, int dex, int men, int luc, int cha, TIntSet classes, TIntIntMap skills, int period)
	{
		_symbolId = symbolId;
		_dyeId = dyeId;
		_dyeLvl = dyeLvl;
