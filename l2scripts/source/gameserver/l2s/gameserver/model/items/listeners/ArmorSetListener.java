...
public final class ArmorSetListener implements OnEquipListener
{
	...
	public void onUnequip(int slot, ItemInstance item, Playable actor)
	{
		...
		for(ArmorSet armorSet : armorSets)
		{
			...
			List<SkillEntry> removeSkillId1 = new ArrayList<SkillEntry>(); 
			List<SkillEntry> removeSkillId2 = new ArrayList<SkillEntry>(); 
			List<SkillEntry> removeSkillId3 = new ArrayList<SkillEntry>(); 
			List<SkillEntry> removeSkillId4 = new ArrayList<SkillEntry>(); 
			List<SkillEntry> removeSkillId5 = new ArrayList<SkillEntry>(); 
