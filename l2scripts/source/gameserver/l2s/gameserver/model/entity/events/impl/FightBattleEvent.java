...
public class FightBattleEvent extends SingleMatchEvent
{
	...
	public void startEvent()
	{
		...
		for(FightBattlePlayerObject registeredPlayer : registeredPlayersTemp)
		{
			...
			{
				String text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.5").toString(player);
	...
	public void stopEvent(boolean force)
	{
		...
		if(force)
		{
			...
			{
				String text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.6").toString(player);
				player.sendPacket(new ExShowScreenMessage(text, 5000, ScreenMessageAlign.TOP_CENTER, true));
				player.sendMessage(text);
			}
		}
	...
	public void announce(SystemMsg msgId, int a, int time)
	{
		switch(a)
		{
			case 0:
				...
				{
					String text;
					text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.0.0").toString(player);
					text += "\n";
					text += new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.0.1").toString(player);
					player.sendPacket(new ExShowScreenMessage(text, 5000, ScreenMessageAlign.TOP_CENTER, true));
			...
			case 1:
				for(Player player : GameObjectsStorage.getPlayers())
				{
					String text;
					if(-time >= 60)
						text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.1.0").addNumber(-time / 60).toString(player);
					else
						text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.1.1").addNumber(-time).toString(player);
					player.sendPacket(new ExShowScreenMessage(text, 5000, ScreenMessageAlign.TOP_CENTER, true));
					player.sendMessage(text);
				}
				break;
			case 2:
				...
				for(Player player : GameObjectsStorage.getPlayers())
				{
					...
					{
						text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.2.0.0").toString(player);
						text += "\n";
						text += new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.2.0.1").addNumber(participantsCount).toString(player);
						player.sendPacket(new ExShowScreenMessage(text, 5000, ScreenMessageAlign.TOP_CENTER, true));
						...
						text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.2.1").toString(player);
					player.sendPacket(new ExShowScreenMessage(text, 5000, ScreenMessageAlign.TOP_CENTER, true));
					player.sendMessage(text);
				}
				break;
			case 3:
				...
				for(Player player : GameObjectsStorage.getPlayers())
				{
					...
					String text;
					if(endEventDelay >= 60)
						text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.3.0").addNumber(endEventDelay / 60).toString(player);
					else
						text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.3.1").addNumber(endEventDelay).toString(player);
					player.sendPacket(new ExShowScreenMessage(text, 5000, ScreenMessageAlign.TOP_CENTER, true));
					player.sendMessage(text);
				}
				break;
			case 4:
				for(Player player : GameObjectsStorage.getPlayers())
				{
					...
					String text = new CustomMessage("l2s.gameserver.model.entity.events.impl.FightBattleEvent.4").toString(player);
					player.sendPacket(new ExShowScreenMessage(text, 5000, ScreenMessageAlign.TOP_CENTER, true));
					player.sendMessage(text);
				}
				break;
	...
	public boolean checkParticipationCond(Player player)
	{
		...
		if(player.getClassLevel().ordinal() < _minClassLevel.ordinal())
			return false;
