...
public abstract class DuelEvent extends AbstractDuelEvent implements Iterable<DuelSnapshotObject>
{
	...
	protected IBroadcastPacket canDuel0(Player requestor, Player target, boolean secondCheck)
	{
		...
		else if(target.isInOlympiadMode() || Olympiad.isRegisteredInComp(target) || requestor.isInOlympiadMode() || Olympiad.isRegisteredInComp(requestor) || target.isChaosFestivalParticipant() || target.isRegisteredInChaosFestival() || requestor.isChaosFestivalParticipant() || requestor.isRegisteredInChaosFestival())
