...
import l2s.gameserver.model.instances.ControlKeyInstance;
...
public class ClanAirShip extends AirShip
{
	...
	public void startArrivalTask()
	{
		...
		{
			player.startScenePlayer(_platform.getOustMovie());
	...
	public List<L2GameServerPacket> deletePacketList(Player forPlayer)
	{
		...
		list.add(new DeleteObjectPacket(_controlKey));
		list.add(new DeleteObjectPacket(this));
		return list;
	}
