...
public final class SkillLearn implements Comparable<SkillLearn>
{
	...
	public SkillLearn(int id, int lvl, int minLvl, int cost, int itemId, long itemCount, boolean autoGet, Race race, int dualClassMinLvl, ClassLevel classLevel)
	{
		_id = id;
		_level = lvl;
		_minLevel = minLvl;
	...
	{
		this(id, lvl, minLvl, cost, itemId, itemCount, autoGet, race, dualClassMinLvl, ClassLevel.NONE);
	}
