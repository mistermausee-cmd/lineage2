...
import l2s.gameserver.network.l2.c2s.RequestWithDrawPremiumItem;
...
public class MerchantInstance extends NpcInstance
{
	...
	{
		return packet == RequestBuyItem.class || packet == RequestSellItem.class || packet == RequestExRefundItem.class || packet == RequestPreviewItem.class || packet == RequestWithDrawPremiumItem.class || super.canPassPacket(player, packet, arg);
	}
