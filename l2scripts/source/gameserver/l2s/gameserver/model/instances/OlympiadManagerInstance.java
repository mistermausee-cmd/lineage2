...
public class OlympiadManagerInstance extends NpcInstance
{
	...
	public void onMenuSelect(Player player, int ask, long reply)
	{
		...
		else if(ask != -80)
		{
	        if (ask == -110)
	        {
	            List<String> names = OlympiadDatabase.getClassLeaderBoard((int)reply);
	            
	            HtmlMessage html = new HtmlMessage(this, "olympiad/olympiad_operator_rank_class.htm");
	...
	public void showChatWindow(Player player, int val, boolean firstTalk, Object... arg)
	{
		if(val == 0)
		{
			...
			if (player.isCursedWeaponEquipped())
				fileName += "olympiad_operator003.htm";
