...
public class ClanSearchManager
{
	...
	public static final long CLAN_LOCK_TIME = 5 * 60 * 1000L; 
	public static final long WAITER_LOCK_TIME = 5 * 60 * 1000L; 
	public static final long APPLICANT_LOCK_TIME = 5 * 60 * 1000L; 

	private static final long CLAN_SEARCH_SAVE_DELAY = 1 * 60 * 60 * 1000L; 
