...
public class Call extends Skill
{
	...
	{
		if(target == null || !target.isPlayer() || target.getPlayer().isTerritoryFlagEquipped() || target.isFlying() || target.isOutOfControl() || !target.getPlayer().getPlayerAccess().UseTeleport)
