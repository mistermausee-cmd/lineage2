...
public class i_summon_cubic extends i_abstract_effect
{
	...
	public i_summon_cubic(Abnormal abnormal, Env env, EffectTemplate template)
	{
		...
		int cubicSubLevel = getTemplate().getParam().getInteger("sub_level", 0);
		...
		_template = CubicHolder.getInstance().getTemplate(cubicId, SkillUtils.getSkillLevelMask(cubicLevel, cubicSubLevel));
	}
