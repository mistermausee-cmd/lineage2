...
public class MemoryOfDisaster extends Reflection
{
	...
	public void dieNextElf()
	{
		...
		if (!elves.isEmpty())
		{
			elves.get(Rnd.get(elves.size())).getAI().notifyEvent(CtrlEvent.EVT_SCRIPT_EVENT, "START_DIE", null, null);
		}
	}
	...
	private class ShowHtmlTask extends RunnableImpl
	{
		...
		public void runImpl()
		{
			...
			QuestState st = player.getQuestState(255);
			if (st != null)
			{
