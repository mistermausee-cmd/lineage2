...
public class SpaciaNormal extends Reflection
{
	...
	public void onPlayerEnter(final Player player)
	{
		if(!introShowed)
		{
			...
			for(Player p : getPlayers()) {
				...
				ItemFunctions.deleteItem(p, 17611, ItemFunctions.getItemCount(player, 17611), true);
			}
	...
	private class DeathListener implements OnDeathListener
	{
		...
		public void onDeath(Creature self, Creature killer)
		{
			...
			{
				//После убийства закена ставим откат инста всем кто заходил в инстант
				...
				addSpawnWithoutRespawn(33385, self.getLoc(), 100);
			}
		}
	}
