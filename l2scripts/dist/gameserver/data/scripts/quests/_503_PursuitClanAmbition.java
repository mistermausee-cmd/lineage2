...
public class _503_PursuitClanAmbition extends Quest
{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				try
				{
					...
					insertion.setString(3, "cond");
					insertion.setInt(4, st.getCondsMask());
	...
	public int getLeaderVar(QuestState st, String var)
	{
		...
		try
		{
			...
			{
				if(cond)
					return leader.getQuestState(getId()).getCond();
				else
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Gustaf && st.isNotAccepted())
		{
