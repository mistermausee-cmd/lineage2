...
public class _10294_SevenSignsMonasteryofSilence extends Quest
{
	...
	private static final int EXP_REWARD = 25000000;	private static final int SP_REWARD = 6000; 	public _10294_SevenSignsMonasteryofSilence()
	{
		...
		addLevelCheck("elcardia_q10294_0.htm", 81);	
		addQuestCompletedCheck("elcardia_q10294_0.htm", 10293);		
	}
	...
	{
		if(checkComplete(st))
			st.getPlayer().startScenePlayer(SceneMovie.SSQ2_HOLY_BURIAL_GROUND_CLOSING);
