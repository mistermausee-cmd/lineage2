...
public class _10425_TheKetraOrcSupporters extends Quest
{
	...
	public _10425_TheKetraOrcSupporters()
	{
		...
		addKillNpcWithLog(1, B_LIST, 100, ZAPAS_MAG);
		addKillId(MOBS);
		addRaceCheck("rugoness_q10425_02a.htm", Race.HUMAN, Race.ELF, Race.DARKELF, Race.ORC, Race.DWARF, Race.KAMAEL);
		addLevelCheck("rugoness_q10425_02.htm", 76, 80);
		addClassTypeCheck("rugoness_q10425_02.htm", ClassType.MYSTIC);
	}

	@Override
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		if(event.equalsIgnoreCase("rugoness_q10425_05.htm"))
		{
			st.setCond(1);
		}
		if(event.equalsIgnoreCase("rugoness_q10425_08.htm"))
		{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch (npcId)
		{
			case LUKONES:
				if (cond == 0)
					htmltext = "rugoness_q10425_01.htm";
				else if (cond == 1)
					htmltext = "rugoness_q10425_06.htm";
				else if (cond == 2)
					htmltext = "rugoness_q10425_07.htm";
				break;
		}
		return htmltext;
	}
