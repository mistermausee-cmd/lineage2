...
public class _10803_TheDimensionalWarpPart3 extends Quest
{
	// NPCs
	private static final int RESHET = 33974;

	// Items
	private static final int AIDOS = 35569;
	private static final int WARPPEACE = 39597;

	private static final int MOB = 23471;

	public static final String A_LIST = "A_LIST";

	private static final int EXP_REWARD = 0;	private static final int SP_REWARD = 100000000; 	public _10803_TheDimensionalWarpPart3()
	{
		super(PARTY_ALL, ONETIME);
		addStartNpc(RESHET);
		addKillNpcWithLog(1, 1023471, A_LIST, 100, MOB);
		addTalkId(RESHET);
		addLevelCheck(RESHET, NO_QUEST_DIALOG, 99);
		addQuestCompletedCheck(NO_QUEST_DIALOG, 10802);
	}
