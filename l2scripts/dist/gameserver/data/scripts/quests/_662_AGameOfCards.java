...
public class _662_AGameOfCards extends Quest
{
	...
	public _662_AGameOfCards()
	{
		...
		addLevelCheck("30845_00.htm", 61/*, 80*/);	
	}
	...
	private static class CardGame
	{
		...
		public CardGame(int _player_id)
		{
			...
			for(int i = 0; i < cards.length; i++)
				cards[i] = "<Button ALIGN=LEFT ICON=\"NORMAL\" action=\"bypass -h npc_%objectId%_QuestEvent _662_AGameOfCards card" + i + "\">?</button>";
		}
		...
		private String finish(QuestState st)
		{
			...
			if(st.getQuestItemsCount(RED_GEM) >= 50)
				result += "<br><br><Button ALIGN=LEFT ICON=\"NORMAL\" action=\"bypass -h npc_%objectId%_QuestEvent _662_AGameOfCards 30845_10.htm\">Play Again!</button>";
			result += html_footer;
			Games.remove(player_id);
			return result;
		}
