...
public class _10301_ShadowOfTerrorBlackishRedFog extends Quest
{
	...
	private static NpcInstance _BigPriest = null;
	...
	private static final int RADAS_LETTER = 17725;

	private static final int WISP = 32938;
	private static final int EXP_REWARD = 26920620;	private static final int SP_REWARD = 6460; 	public _10301_ShadowOfTerrorBlackishRedFog()
	{
		...
		addLevelCheck("33100-lvl.htm", 88);
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equalsIgnoreCase("17725-01.htm"))
		{
				st.setCond(1);
				return "17725-01.htm";
		}
		...
		else if(event.equalsIgnoreCase("initNpcs"))
		{
			...
			_BigPriest = player.getReflection().addSpawnWithoutRespawn(33362, new Location(183961, 85734, -7752, 19716), 0);
		...
		else if(event.equalsIgnoreCase("ExitInstance"))
		{
			...
			st.getPlayer().teleToLocation(207559, 86429, -1000, ReflectionManager.MAIN);
			return null;
		}	
		return event;
	}
	...
	public String onCompleted(NpcInstance npc, QuestState st)
	{
		...
		if(npc.getNpcId() == RADA)
			htmltext = "33100-comp.htm";
		else if(npc.getNpcId() == SLAKI)
