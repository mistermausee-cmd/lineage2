 ...
 * @author Iqman
 */
public class _10411_KekporusLetterTheForestOfTheDead extends Quest
{
    //Квестовые персонажи
	...
	private static class PlayerEnterListener implements OnPlayerEnterListener
	{
		...
		{
			QuestState questState = player.getQuestState(10411);
			if(questState == null)
				return;
	...
	public _10411_KekporusLetterTheForestOfTheDead()
	{
