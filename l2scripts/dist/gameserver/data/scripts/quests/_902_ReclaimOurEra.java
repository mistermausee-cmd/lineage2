...
public class _902_ReclaimOurEra extends Quest
{
	...
	private static final int[] OrcsSilenos = {25309, /*TODO: 25312, 25315, */25299, /*TODO: 25302, 25305*/};
	...
	public _902_ReclaimOurEra()
	{
		...
		addLevelCheck("mathias_q902_00.htm", 80);
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npc.getNpcId() == Mathias)
		{
			if(cond == 0)
				...
				htmltext = "mathias_q902_09.htm";
			else if(cond == 4)
				htmltext = "mathias_q902_10.htm";
			else if(cond == 5)
			{
