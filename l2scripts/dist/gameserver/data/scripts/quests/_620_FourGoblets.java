...
public class _620_FourGoblets extends Quest
{
	...
	public _620_FourGoblets()
	{
		...
		for(int id = 18120; id <= 18256; id++)
			addKillId(id);
		addLevelCheck("31453-12.htm", 74/*, 80*/);	
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("18"))
		{
			...
			return "<html><body><Button ALIGN=LEFT ICON=\"NORMAL\" action=\"bypass -h npc_%objectId%_QuestEvent _620_FourGoblets 19\">\"Please open a box.\"</button><Button ALIGN=LEFT ICON=\"NORMAL\" action=\"bypass -h npc_%objectId%_QuestEvent _620_FourGoblets 19 5\">\"Please open 5 boxes.\"</button><Button ALIGN=LEFT ICON=\"NORMAL\" action=\"bypass -h npc_%objectId%_QuestEvent _620_FourGoblets 19 10\">\"Please open 10 boxes.\"</button><Button ALIGN=LEFT ICON=\"NORMAL\" action=\"bypass -h npc_%objectId%_QuestEvent _620_FourGoblets 19 50\">\"Please open 50 boxes.\"</button></body></html>";
		else
		{
			int id = 0;
			try
