...
public class _10296_SevenSignsPoweroftheSeal extends Quest
{
	...
	private static final int EXP_REWARD = 70000000;	private static final int SP_REWARD = 16800; 	public _10296_SevenSignsPoweroftheSeal()
	{
		super(PARTY_NONE, ONETIME);
		addStartNpc(Eris);
		addTalkId(ElcardiaInzone1, ElcardiaHome, Hardin, Wood, Franz);
		addKillId(EtisEtina);
		addLevelCheck("eris_q10296_0.htm", 81);
		addQuestCompletedCheck("eris_q10296_0.htm", 10295);			
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("start_scene"))
		{
			...
			player.startScenePlayer(SceneMovie.SSQ2_BOSS_OPENING);
			return null;
		}
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == EtisEtina)
		{
			...
			st.getPlayer().startScenePlayer(SceneMovie.SSQ2_BOSS_CLOSING);
