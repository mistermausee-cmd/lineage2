...
public class _386_StolenDignity extends Quest
{
	...
	public _386_StolenDignity()
	{
		...
		//TODO: dropchances.put(21108, 19);
		dropchances.put(21110, 18);
		dropchances.put(21113, 25);
		//TODO: dropchances.put(21114, 23);
		dropchances.put(21116, 25);

		for(int kill_id : dropchances.keySet())
			addKillId(kill_id);
		addLevelCheck("warehouse_keeper_romp_q0386_04.htm", 58/*, 75*/);	
	}
	...
	public static class Bingo extends quests.Bingo
	{
		...
		private final static String template_choice = "<Button ALIGN=LEFT ICON=\"NORMAL\" action=\"bypass -h npc_%objectId%_QuestEvent _386_StolenDignity choice-%n%\">%n%</button>&nbsp;&nbsp;&nbsp;&nbsp;  ";
