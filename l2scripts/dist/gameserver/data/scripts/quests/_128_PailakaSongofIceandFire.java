...
public class _128_PailakaSongofIceandFire extends Quest
{
	...
	// REWARDS
	private static int[] REWARDS = { 32164, 32163, 32132, 31700, 31859, 31708, 31940, 31857, 31602, 31752, 31889, 31604 };
	...
	private static final int EXP_REWARD = 1860000;	private static final int SP_REWARD = 446; 	public _128_PailakaSongofIceandFire()
	{
		...
		addLevelCheck("32497-no.htm", 49/*, 55*/);
	}
	...
	public String onCompleted(NpcInstance npc, QuestState st)
	{
		...
		if(npc.getNpcId() == ADLER)
			htmltext = "32497-no.htm";
		else if(npc.getNpcId() == ADLER2)
