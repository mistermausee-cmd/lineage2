...
public class _10283_RequestOfIceMerchant extends Quest
{
	...
	private static final int EXP_REWARD = 627000;	private static final int SP_REWARD = 150; 	public _10283_RequestOfIceMerchant()
	{
		...
		addLevelCheck("32020-00.htm", 82);
		addQuestCompletedCheck("32020-00.htm", 115);
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == _kier && cond == 2)
			htmltext = "32022-01.htm";
		else if(npcId == _jinia && cond == 2)
