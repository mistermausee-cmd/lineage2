...
public class _10295_SevenSignsSolinasTomb extends Quest
{
	...
	private static final int EXP_REWARD = 44000000;	private static final int SP_REWARD = 10560; 	public _10295_SevenSignsSolinasTomb()
	{
		...
		addLevelCheck("eris_q10295_0a.htm", 81);	
		addQuestCompletedCheck("eris_q10295_0a.htm", 10294);			
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("teleport_realtomb"))
		{
			...
			teleportElcardia(player);
			player.startScenePlayer(SceneMovie.SSQ2_ELYSS_NARRATION);
			return null;
		}
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		{
			player.startScenePlayer(SceneMovie.SSQ2_SOLINA_TOMB_CLOSING);
			player.getReflection().removeEventTrigger(21100100);
			player.getReflection().addEventTrigger(21100102);
		}
