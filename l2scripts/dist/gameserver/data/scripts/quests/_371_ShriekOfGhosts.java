...
public class _371_ShriekOfGhosts extends Quest
{
	...
	// Mobs
	private static int Ledi_esm = 23104;
	private static int ranger_guard = 23105;
	private static int Maid_esmer = 23106;
	private static int voin_oxranu = 23106;
	// Items
	...
	public _371_ShriekOfGhosts()
	{
		...
		addKillId(Ledi_esm);
		addKillId(ranger_guard);
		addKillId(Maid_esmer);
		addKillId(voin_oxranu);

		addQuestItem(Ancient_Ash_Urn);

		common_chances.put(Ledi_esm, 71);
		common_chances.put(ranger_guard, 74);
		common_chances.put(Maid_esmer, 82);
		common_chances.put(voin_oxranu, 82);
		addLevelCheck("30867-01.htm", 59/*, 71*/);
	}
	...
	{
		Player player = qs.getRandomPartyMember(qs.getCond(), Config.ALT_PARTY_DISTRIBUTION_RANGE);
		if(player == null)
			return null;
