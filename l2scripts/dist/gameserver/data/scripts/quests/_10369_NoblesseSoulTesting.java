...
**/
public class _10369_NoblesseSoulTesting extends Quest
{
	...
	private static class MagicHitListener implements OnMagicHitListener
	{
		@Override
		public void onMagicHit(Creature actor, Skill skill, Creature caster)
		{
			...
			QuestState qs = caster.getPlayer().getQuestState(10369);
			if(qs == null)
				return;
	...
	private final static OnMagicHitListener MAGIC_HIT_LISTENER = new MagicHitListener();
		...
		switch(npcId)
		{
			...
			case EVAS_AVATAR:
			{
				...
				else if(cond == 18)
				{
					...
					st.finishQuest();
					st.getPlayer().setNobleType(NobleType.NORMAL);
				}
				break;
			}
			case LANYA:
	...
	private void init()
	{
		CharListenerList.addGlobal(MAGIC_HIT_LISTENER);
