...
public class Bronk_19192 extends Dwarvs
{
	...
	protected void onEvtTimer(int timerId, Object arg1, Object arg2)
	{
		...
		{
			case 1:
				Functions.npcSayInRange(getActor(), 1500, NpcString.MM_I_SEE);
				List<NpcInstance> list = r.getAllByNpcId(TOROCCO_ID, true);
				if(list.size() > 0)
				{
					NpcInstance torocco = list.get(0);
					torocco.getAI().notifyEvent(CtrlEvent.EVT_SCRIPT_EVENT, "TOROCCO_1", "empty", "empty");
				}
				break;
			case 2:
			...
			case 8:
				...
				break;
			case 9:
				Functions.npcSayInRange(getActor(), 1500, NpcString.UGH_IF_I_SEE_YOU_IN_THE_SPIRIT_WORLD_FIRST_ROUND_IS_ON_ME);
				addTimer(11, 1000);
				addTimer(10, 1600);
				addTimer(10, 2400);
				addTimer(10, 3600);
