...
public class Succubus extends Fighter
{
	...
	protected void onEvtDead(Creature killer)
	{
		...
		SkillHolder.getInstance().getSkill(14975, 1).getEffects(killer, killer);
		SkillHolder.getInstance().getSkill(14976, 1).getEffects(killer, killer);
		SkillHolder.getInstance().getSkill(14977, 1).getEffects(killer, killer);
