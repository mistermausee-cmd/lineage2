...
public class EliteMobs extends Fighter
{
	...
	public EliteMobs(NpcInstance actor)
	{
		...
		//_buffs.add(SkillHolder.getInstance().getSkill(14975, 1));
		//_buffs.add(SkillHolder.getInstance().getSkill(14976, 1));
		//_buffs.add(SkillHolder.getInstance().getSkill(14977, 1));	
	}
	...
	protected void onEvtDead(Creature killer)
	{
		...
		for (Skill skill : _buffs)
		{
			...
			skill.getEffects(killer, killer);
		}
