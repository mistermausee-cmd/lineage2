...
public class SeekerEscort extends DefaultAI
{
	...
	protected void onEvtThink()
	{
		if(getIntention() != CtrlIntention.AI_INTENTION_FOLLOW)
		{
			if(_followPlayer != null)
				changeIntention(CtrlIntention.AI_INTENTION_FOLLOW, _followPlayer, Config.FOLLOW_RANGE);
		}
		super.onEvtThink();
	}
	...
	protected void thinkFollow()
	{
		...
		if(_intention_arg0 == null || !(_intention_arg0 instanceof Player))
		{
			actor.deleteMe();
			return;
		}
		...
		QuestState st = player.getQuestState(10365);
		if(st == null)
		{
			actor.deleteMe();
			return;
