	...
	protected void onEvtAttacked(Creature attacker, Skill skill, int damage)
	{
		...
		if(System.currentTimeMillis() - _lastAction > 3000)
		{
			...
			if(chance < 2)
				...
				actor.doCast(SkillHolder.getInstance().getSkillEntry(4578, 1), attacker, true); // Petrification
			else
				actor.doCast(SkillHolder.getInstance().getSkillEntry(4185, 7), attacker, true); // Sleep
