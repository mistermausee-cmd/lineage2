...
/**
 ...
 28.10.2016
 */
public class BalokCleftMonsterAI extends Fighter
{
	public BalokCleftMonsterAI(NpcInstance actor)
	{
		super(actor);
		actor.setRunning();
	}
	...
	private void cast(Creature target)
	{
		Skill skill = SkillHolder.getInstance().getSkill(Rnd.chance(50) ? 14250 : 14251, 1);
