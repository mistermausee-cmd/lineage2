...
public class InstantClanHallManagerAI extends NpcAI
{
	...
	private static final int aden_tel_time = 1005;
	private static final int rune_tel_time = 1006;
	private static final int talkingIsle_tel_time = 1007;
		...
		else if(timerId == rune_tel_time)
		{
			if(arg1 != null && (arg1 instanceof Player))
			{
				...
				switch(Rnd.get(3))
				{
					case 0:
					{
						player.teleToLocation(43744, -48357, -792, ReflectionManager.MAIN);
						break;
					}
					case 1:
					{
						player.teleToLocation(43039, -48251, -792, ReflectionManager.MAIN);
						break;
					}
					case 2:
					{
						player.teleToLocation(44532, -48109, -792, ReflectionManager.MAIN);
						break;
					}
				}
			}
		}
		else if(timerId == talkingIsle_tel_time)
		{
			if(arg1 != null && (arg1 instanceof Player))
			{
				Player player = (Player) arg1;
				...
				switch(Rnd.get(3))
				{
					case 0:
					{
						player.teleToLocation(-116309, 256636, -1512, ReflectionManager.MAIN);
						break;
					}
					case 1:
					{
						player.teleToLocation(-116266, 256627, -1512, ReflectionManager.MAIN);
						break;
					}
					case 2:
					{
						player.teleToLocation(-116278, 256665, -1520, ReflectionManager.MAIN);
						break;
					}
				}
			}
