...
public class DragonTreater extends Priest
{
	public DragonTreater(NpcInstance actor)
	{
		super(actor);
	...
	private Creature getTopDesireTarget()
	{
		...
		if(r != null)
		{
			...
			{
				BaltusKnight baltusinst = (BaltusKnight) r;
				if (baltusinst.getAntharas() != null && !baltusinst.getAntharas().isDead())
				{
					return baltusinst.getAntharas();
				}
			}
		}
		return getActor();
