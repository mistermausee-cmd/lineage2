	...
	protected void onEvtSeeSpell(Skill skill, Creature caster, Creature target)
	{
		...
		if(actor.isInZone(ZoneType.dummy))
		{
			switch(actor.getNpcState())
			{
				case 1:
					if(Rnd.chance(80))
						actor.doCast(SkillHolder.getInstance().getSkillEntry(maguenRaceSkills[0], Rnd.get(2, 3)), caster, true);
					else
						actor.doCast(SkillHolder.getInstance().getSkillEntry(maguenStatsSkills[0], Rnd.get(1, 2)), caster, true);
					break;
				case 2:
					if(Rnd.chance(80))
						actor.doCast(SkillHolder.getInstance().getSkillEntry(maguenRaceSkills[1], Rnd.get(2, 3)), caster, true);
					else
						actor.doCast(SkillHolder.getInstance().getSkillEntry(maguenStatsSkills[1], Rnd.get(1, 2)), caster, true);
					break;
				case 3:
					if(Rnd.chance(80))
						actor.doCast(SkillHolder.getInstance().getSkillEntry(maguenRaceSkills[2], Rnd.get(2, 3)), caster, true);
					else
						actor.doCast(SkillHolder.getInstance().getSkillEntry(maguenStatsSkills[2], Rnd.get(1, 2)), caster, true);
					break;
				default:
					break;
			}
		...
		else
		{
			...
			{
				case 1:
					actor.doCast(SkillHolder.getInstance().getSkillEntry(maguenRaceSkills[0], 1), caster, true);
					break;
				case 2:
					actor.doCast(SkillHolder.getInstance().getSkillEntry(maguenRaceSkills[1], 1), caster, true);
					break;
				case 3:
					actor.doCast(SkillHolder.getInstance().getSkillEntry(maguenRaceSkills[2], 1), caster, true);
					break;
				default:
					break;
			}
