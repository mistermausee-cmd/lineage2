...
public class TheFlowOfTheHorror implements OnInitScriptListener
{
	...
	private static void spawn(int id, List<Location> points)
	{
		...
		MonsterInstance monster = new MonsterInstance(IdFactory.getInstance().getNextId(), template, StatsSet.EMPTY);
	 ...
	 * Запускает эвент
	 */
	@Bypass("events.TheFlowOfTheHorror.TheFlowOfTheHorror:startEvent")
	 ...
	 * Останавливает эвент
	 */
	@Bypass("events.TheFlowOfTheHorror.TheFlowOfTheHorror:stopEvent")
