...
public final class PortalCubeInstance extends NpcInstance
{
	...
	public PortalCubeInstance(int objectId, NpcTemplate template, MultiValueSet<String> set)
	{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.equalsIgnoreCase("spawn_spezion_hard"))
		{
			((SpaciaHard) getReflection()).spazionSpawn();
