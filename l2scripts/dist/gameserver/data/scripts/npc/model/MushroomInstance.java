...
{	
	...
	private static final int FANTASY_MUSHROOM_SKILL = 6622;
	private static final int FANTASY_MUSHROOM_ANIM_SKILL = 6427;
	...
	public MushroomInstance(int objectId, NpcTemplate template, MultiValueSet<String> set)
	{
	...
	public static class TaskAfterDead extends RunnableImpl
	{
		...
		public void runImpl() throws Exception
		{
			...
			{
				_actor.broadcastPacket(new MagicSkillUse(_actor, FANTASY_MUSHROOM_ANIM_SKILL, 1, 0, 0));
			...
			if(_killer != null && _killer.isPlayer() && !_killer.isDead())
			{
				...
				_skill.onEndCast(_killer, targets);
			}
		}
	}
}