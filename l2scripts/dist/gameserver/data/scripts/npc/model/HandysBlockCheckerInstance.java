...
import l2s.gameserver.network.l2.s2c.ExCubeGameChangeTimeToStart;
import l2s.gameserver.network.l2.s2c.ExCubeGameRequestReady;
...
public class HandysBlockCheckerInstance extends NpcInstance
{
	...
	public HandysBlockCheckerInstance(int objectId, NpcTemplate template, MultiValueSet<String> set)
	{
