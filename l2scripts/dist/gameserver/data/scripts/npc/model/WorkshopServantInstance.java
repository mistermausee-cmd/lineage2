...
public class WorkshopServantInstance extends NpcInstance
{
	...
	public WorkshopServantInstance(int objectId, NpcTemplate template, MultiValueSet<String> set)
	{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if(command.startsWith("acceptjob"))
		{
			...
			player.altOnMagicUse(player, SkillHolder.getInstance().getSkill(5526, 1));
			player.teleToLocation(22616, 244888, 11062);
		}
