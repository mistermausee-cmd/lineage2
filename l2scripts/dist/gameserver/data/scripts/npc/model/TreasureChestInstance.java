...
public class TreasureChestInstance extends ChestInstance
{
	...
	{
		SkillEntry bomb = SkillHolder.getInstance().getSkillEntry(TREASURE_BOMB_SKILL_ID, getBombLvl());
		if(bomb != null)
	...
	@Override
	public void onReduceCurrentHp(final double damage, final Creature attacker, Skill skill, final boolean awake, final boolean standUp, boolean directHp, boolean isDot)
	{
		if(!isCommonTreasureChest())
			fakeOpen(attacker);
	}
