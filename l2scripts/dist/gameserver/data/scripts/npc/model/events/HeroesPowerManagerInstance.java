...
public class HeroesPowerManagerInstance extends NpcInstance
{
	...
	public HeroesPowerManagerInstance(int objectId, NpcTemplate template, MultiValueSet<String> set)
	{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if(cmd.equalsIgnoreCase("givescroll"))
		{
			...
			{
				showChatWindow(player, "events/heroes_power/" + getNpcId() + "-give_scroll.htm", false);
				...
				showChatWindow(player, "events/heroes_power/" + getNpcId() + "-have_scroll.htm", false);
		}
		else
