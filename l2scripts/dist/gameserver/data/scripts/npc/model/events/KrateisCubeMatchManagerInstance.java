...
public class KrateisCubeMatchManagerInstance extends NpcInstance
{
	...
	public KrateisCubeMatchManagerInstance(int objectId, NpcTemplate template, MultiValueSet<String> set)
	{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if(command.startsWith("KrateiEnter"))
		{
			...
			else
			{
				...
				player.teleToLocation(Rnd.get(locs), ReflectionManager.MAIN);
			}
		}
