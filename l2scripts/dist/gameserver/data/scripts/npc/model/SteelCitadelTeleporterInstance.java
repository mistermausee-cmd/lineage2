...
public class SteelCitadelTeleporterInstance extends NpcInstance
{
	...
	public SteelCitadelTeleporterInstance(int objectId, NpcTemplate template, MultiValueSet<String> set)
	{
	...
	public void onBypassFeedback(Player player, String command)
	{
		if(!player.isInParty())
		{
			showChatWindow(player, "default/32745-1.htm", false);
			return;
		}
		if(player.getParty().getPartyLeader() != player)
		{
			showChatWindow(player, "default/32745-2.htm", false);
			return;
		}
