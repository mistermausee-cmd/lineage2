...
public final class RumieseNpcInstance extends NpcInstance
{
	...
	public RumieseNpcInstance(int objectId, NpcTemplate template, MultiValueSet<String> set)
	{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if(command.equalsIgnoreCase("request_givedevice"))
		{
			if (player.getInventory().getItemByItemId(17608) == null)
			{
				player.getInventory().addItem(17608, 1L);
				showChatWindow(player, "default/33151-ok.htm", false);
			}
			else
				showChatWindow(player, "default/33151-no.htm", false);
		}
		else
