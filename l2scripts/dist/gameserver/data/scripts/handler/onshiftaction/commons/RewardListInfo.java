...
public abstract class RewardListInfo
{
	...
	public static void showInfo(Player player, NpcInstance npc, RewardType showType, int page)
	{
		...
		else
		{
			...
			List<RewardList> luckyRewardLists = new ArrayList<RewardList>();
			...
			content.append(makeRewardListInfo(player, tpls, npc, luckyRewardLists, RewardType.LUCKY, tpls.get(13), mod, showType == RewardType.LUCKY, page));
