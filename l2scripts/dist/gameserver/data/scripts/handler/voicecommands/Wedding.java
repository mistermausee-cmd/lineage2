...
public class Wedding extends ScriptVoiceCommandHandler
{
	...
	public boolean goToLove(Player activeChar)
	{
		...
		if(partner.isInOlympiadMode() || activeChar.isMovementDisabled() || activeChar.isMuted(null) || activeChar.isInOlympiadMode() || activeChar.containsEvent(SingleMatchEvent.class) || partner.containsEvent(SingleMatchEvent.class) || activeChar.getPlayer().isTerritoryFlagEquipped() || partner.isInZone(no_summon))
		{
