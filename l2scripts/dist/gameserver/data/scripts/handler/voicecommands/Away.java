...
public class Away extends ScriptVoiceCommandHandler
{
	...
	private boolean away(Player activeChar, String text)
	{
		...
		{
			activeChar.sendMessage(new CustomMessage("l2s.gameserver.handler.voicecommands.impl.Away.Cursed"));
			return false;
		}
		...
		{
			activeChar.sendMessage(new CustomMessage("l2s.gameserver.handler.voicecommands.impl.Away.Rift"));
			return false;
		}
