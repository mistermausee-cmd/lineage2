...
ALTER TABLE fortress ADD COLUMN `owner_id` INT NOT NULL DEFAULT '0' AFTER `last_siege_date`;
...
UPDATE fortress LEFT JOIN clan_data ON clan_data.hasFortress = fortress.id SET fortress.owner_id = clan_data.clan_id WHERE clan_data.hasFortress IS NOT NULL;
...
ALTER TABLE clan_data DROP COLUMN hasFortress;
