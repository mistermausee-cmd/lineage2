CREATE TABLE IF NOT EXISTS `character_subclasses` (
	...
	`default_class_id` TINYINT UNSIGNED NOT NULL,
	...
	`dual_certification` INT NOT NULL,
	`vitality` INT UNSIGNED NOT NULL DEFAULT '140000',
	`used_vitality_potions` TINYINT UNSIGNED NOT NULL DEFAULT '0',
